        ...
        public  List<SubregionModel> ObtenerSubregiones()
        {
            return new List<SubregionModel>
            {
                ...
                new SubregionModel
                {
                    ...
                    contenido =
                        "La subregión de Piedemonte Amazónico, integrada por los municipios de Piamonte y Santa Rosa, se ubica en la Bota Caucana y representa la puerta de entrada a la selva amazónica en el departamento. Su mayor riqueza es el vasto patrimonio natural donde convergen los biomas andino y amazónico, creando escenarios ideales para el turismo de naturaleza, el avistamiento de aves, caminatas ecológicas y fotografía de paisajes. Entre sus principales atractivos se destacan el Parque Nacional Natural Serranía de los Churumbelos Auka-Wasi, cascadas como Nabueno, La Honda y La Cristalina, además de espacios naturales como el Río Congor, Río Tambor y el muelle sobre el río Caquetá. Esta subregión alberga una gran diversidad de fauna, incluyendo especies como jaguares, dantas, osos de anteojos, osos hormigueros y pirarucús, consolidándose como uno de los territorios de mayor valor ecosistémico del Cauca.",
                ...
                new SubregionModel
                {
                    ...
                    contenido =
                        "La subregión Macizo del Cauca, ubicada sobre la cordillera suroccidental, es reconocida como Reserva de la Biosfera por la Unesco bajo la denominación “Cinturón Andino” y como una de las principales estrellas fluviales del país. Integrada por los municipios de Almaguer, La Sierra, La Vega, Rosas, Santa Rosa y San Sebastián, esta subregión se destaca por sus paisajes naturales, más de 30 lagunas y afluentes que dan origen a ríos emblemáticos como el Magdalena, Caquetá y Patía, convirtiéndola en un destino ideal para el turismo de naturaleza y avistamiento de aves. Entre sus principales atractivos sobresalen el Primer Museo Vivo del Agua de América Latina en San Sebastián; el complejo de páramos de Sotará y Los Bellones; la Laguna de San Andrés y el Mirador de Quebrada Azul en La Sierra; así como rutas agroculturales y recorridos por cuerpos lagunares dentro del Parque Nacional Natural Puracé. Además, Santa Rosa, conocido como el portal a la Amazonía colombiana, se posiciona como referente en avistamiento de aves, gracias a su gran diversidad de especies y espacios naturales como la Reserva Natural Paraíso Bombonas y la Serranía de los Churumbelos Auka Wasi.",
